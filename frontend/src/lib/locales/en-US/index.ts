export const enUS = {
  ...
  settings: {
    ...
    docHelp: "· Docling is a little slower but more accurate, specially if the documents contain tables and images. · LiteParse is a fast, lightweight parser with built-in OCR (Tesseract). Great for quick text extraction; for complex tables/charts, pair it with a Vision LLM. · Simple will extract any content from the document without formatting it. · Auto (recommended) will try to process through docling and default to simple.",
    firecrawl: "Firecrawl",
    jina: "Jina",
